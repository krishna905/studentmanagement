...
import './form.css';
import { createPost, updatePost } from '../../02Redux/actions';
...
const Form = ({ currentId, setCurrentId }) => {
  ...
  return (
    <div>
      <div className="form-page1 border border-primary">
        <div className=" form1 bg-white container">
          ...
          >
            ...
            <button className="button sub" color="primary" type="submit">
              Submit
            </button>
            <button className="button clr" size="small" onClick={clear}>
              Clear
            </button>
          </form>
        </div>
